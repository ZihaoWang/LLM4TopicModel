...
def get_args() -> Namespace:
    ...
    parser.add_argument("--test", default = False, dest='test', action='store_true', help = "Only do inference")
    ...
    parser.add_argument("--max_doc_length", type = int, default = 256, help = "Maximum size of documents.")
    ...
    parser.add_argument("--test_batch_size", default = 64, type = int, help = "inference batch size")
    ...
    parser.add_argument("--early_stopping", default = True, type = bool, help = "in ppo training")
    ...
    parser.add_argument("--lora_r", default = 8, type = int, help = "")
    parser.add_argument("--lora_alpha", default = 16, type = int, help = "")
